...
?>
        ...
        <div class="w3-top">
          <div class="w3-bar w3-black w3-card-2 w3-left-align w3-medium">
            ...
            <a style="cursor:pointer;" onclick="log_out_user_event()" id="log_out_large" class="w3-right w3-bar-item w3-blink w3-hide-small w3-button w3-padding-large w3-hover-white"><i class="fa fa-external-link-square"></i> Log Out</a>
          </div>
          ...
          <div id="navDemo" class="w3-bar-block w3-black w3-hide w3-hide-large w3-hide-medium w3-medium">
              ...
              <a style="cursor:pointer;" onclick="log_out_user_event()" id="log_out_small" class="w3-bar-item w3-button w3-blink w3-padding-large"><i class="fa fa-external-link-square"></i> Log Out</a>
          </div>
        </div>
...
?>
        ...
        <div class="w3-top">
          <div class="w3-bar w3-black w3-card-2 w3-left-align w3-medium">
            ...
            <a style="cursor:pointer;display:none;" onclick="log_out_user_event_2()" id="log_out_large" class="w3-right w3-bar-item w3-blink w3-hide-small w3-button w3-padding-large w3-hover-white"><i class="fa fa-external-link-square"></i> Log Out</a>
          </div>
          <!-- Navbar on small screens -->
          <div id="navDemo" class="w3-bar-block w3-black w3-hide w3-hide-large w3-hide-medium w3-medium">
            ...
            <a style="display:none;" href="contact.php" id="contact_small" class=" w3-bar-item w3-button w3-padding-large">Contact</a>
              ...
              <a style="cursor:pointer;display:none;" onclick="log_out_user_event_2()" id="log_out_small" class="w3-bar-item w3-button w3-blink w3-padding-large"><i class="fa fa-external-link-square"></i> Log Out</a>
          </div>
        </div>
<?php
    }
...
<div class="w3-row-padding w3-padding-64 w3-container w3-light-gray">
    ...
    <?php    
        if(isset($_SESSION['username']) && isset($_SESSION['password']) && isset($_SESSION['email']))
        {
            ...
            include("include/show_insider_event.php");
    ?>
            ...
            <div class="w3-container w3-center w3-padding-32" style="height:400px;overflow-y:scroll;display:none;" id="login_form">
        		<div class="w3-container w3-card-4 w3-light-grey" style="width:60%;margin:0 auto;">
        		    ...
        		    <div class="w3-container">
                    	...
                    	<p class="w3-center">
                    	    <button onclick="admin_login_auth_event()" class="w3-button w3-section w3-logo-color w3-ripple w3-round w3-medium w3-hover-black"> <i class="fa fa-spinner fa-spin" id="login_loading" style="display:none;"></i> Log In </button>
                    	</p>
            	    </div>
        		</div>
        	</div>
	...
	<?php
	        ...
	        include("include/hide_insider_event.php");
        }
    ?>
